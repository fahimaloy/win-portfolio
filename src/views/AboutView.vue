<template>
  <div class="top">
    <div class="left">
      <img src="../icons/arrowLeft.svg" alt="Go Backward Icon" @click="window.history.back()">
      <img src="../icons/arrowRight.svg" alt="Go Forward Icon" @abort="window.history.forward()">
      <img src="../icons/refresh.svg" alt="Refresh Icon" @click="window.location.reload()">
    </div>
    <div class="center">
      <label>
        <img src="../icons/search.svg" alt="Search Icon">
        <input type="url" class="url" placeholder="Search or enter web address" autofocus spellcheck="false"
          autocomplete="url" value="" @keydown="if(event.key == 'Enter')loadURL(this.value)"
